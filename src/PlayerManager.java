...
public class PlayerManager {
    ...
    public PlayerManager(GameBoard gameBoard)
    {
        this._gameBoard = gameBoard;
    }

    public PlayerManager(GameBoard gameBoard, Player[] players)
    {
        this._gameBoard = gameBoard;
        this._playerLibrary = players;
    }

    public PlayerManager(GameBoard gameBoard, Player[] players, Player currentPlayer)
    {
        this._gameBoard = gameBoard;
        this._playerLibrary = players;
    ...
    public PlayerManager(GameBoard gameBoard, Player[] players, Player currentPlayer, RulesPackage rules)
    {
        this._gameBoard = gameBoard;
        this._playerLibrary = players;
        this._currentPlayer = currentPlayer;
